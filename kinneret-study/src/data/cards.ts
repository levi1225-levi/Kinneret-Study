...
export const cards: Card[] = [
  // ─── Core Concepts ───────────────────────────────────────────────
  {
    ...
    term: 'Halachah',
    definition: 'Jewish religious law derived from the Torah and rabbinic tradition.',
    extendedNotes:
  ...
  },
  {
    ...
    definition: 'The Written Torah — the Five Books of Moses and, by extension, the entire Tanach.',
    extendedNotes:
  ...
  },
  {
    ...
    definition: 'The Oral Torah — the body of interpretation, explanation, and application transmitted orally from Sinai and later written in the Mishnah and Talmud.',
    extendedNotes:
  ...
  // ─── Texts ───────────────────────────────────────────────────────
  {
    ...
    term: 'Chumash',
    definition: 'The Five Books of Moses (Pentateuch): Genesis, Exodus, Leviticus, Numbers, Deuteronomy.',
    extendedNotes:
  ...
  },
  {
    ...
    term: 'Tanach',
    definition: 'The Hebrew Bible — an acronym for Torah (Teaching), Nevi\'im (Prophets), and Ketuvim (Writings). Contains 24 books.',
    extendedNotes:
  ...
  },
  {
    ...
    term: 'Mishnah',
    definition: 'The first major written compilation of the Oral Torah, organized into six orders, compiled by Rabbi Yehudah HaNasi around 200 CE.',
    extendedNotes:
  ...
  },
  {
    ...
    term: 'Gemara',
    definition: 'Rabbinic commentary and analysis of the Mishnah, compiled by the Amora\'im. Together with the Mishnah, it forms the Talmud.',
    extendedNotes:
  ...
  },
  {
    ...
    term: 'Talmud',
    definition: 'The central text of rabbinic Judaism, consisting of the Mishnah plus the Gemara. Exists in two versions: Babylonian (Bavli) and Jerusalem (Yerushalmi).',
    extendedNotes:
  ...
  },
  {
    ...
    definition: 'The Babylonian Talmud — compiled in the Jewish academies of Babylonia (modern Iraq), completed around 500 CE. The more authoritative and widely studied of the two Talmuds.',
    extendedNotes:
  ...
  },
  {
    ...
    definition: 'The Jerusalem Talmud — compiled in the academies of the Land of Israel, completed around 400 CE. Shorter and less studied than the Bavli.',
    extendedNotes:
  ...
  },
  {
    ...
    term: 'Baraita',
    definition: 'A teaching from the Tanaitic period (same era as the Mishnah) that was not included in Rabbi Yehudah HaNasi\'s Mishnah but is quoted in the Gemara.',
    extendedNotes:
  ...
  },
  {
    ...
    term: 'Shas',
    definition: 'An acronym for "Shishah Sedarim" (Six Orders) — a common name for the entire Talmud.',
    extendedNotes:
  ...
  },
  {
    ...
    term: 'Apocrypha',
    definition: 'Jewish texts from the Second Temple period that were not included in the Jewish biblical canon but are preserved in some Christian traditions.',
    extendedNotes:
  ...
  },
  {
    ...
    definition: 'The "New Testament" — Christian scriptures not part of the Jewish canon. The Hebrew term literally means "the New Covenant."',
    extendedNotes:
  ...
  // ─── Sages ───────────────────────────────────────────────────────
  {
    ...
    term: 'Tana\'im',
    definition: 'The rabbinic sages whose teachings are recorded in the Mishnah, active from approximately 10–200 CE.',
    extendedNotes:
  ...
  },
  {
    ...
    term: 'Amora\'im',
    definition: 'The rabbinic sages whose teachings are recorded in the Gemara, active from approximately 200–500 CE.',
    extendedNotes:
  ...
  // ─── Structure ───────────────────────────────────────────────────
  {
    ...
    term: 'Seder (Order)',
    definition: 'One of the six major divisions (orders) of the Mishnah and Talmud, each covering a broad area of Jewish law.',
    extendedNotes:
  ...
  },
  {
    ...
    definition: 'A tractate — a thematic subdivision within a seder, focusing on a specific area of law.',
    extendedNotes:
  ...
  },
  {
    ...
    term: 'Daf (Page/Folio)',
    definition: 'A page (folio) of the Talmud. Each daf has two sides: amud alef (side a) and amud bet (side b).',
    extendedNotes:
  ...
  },
  {
    ...
    definition: 'One side of a Talmudic daf (page). Amud Alef (a) is the front; Amud Bet (b) is the back.',
    extendedNotes:
  ...
  },
  {
    ...
    definition: 'A halachic disagreement or dispute between sages recorded in the Mishnah or Talmud.',
    extendedNotes:
  ...
  // ─── Law Codes ───────────────────────────────────────────────────
  {
    ...
    term: 'Mishneh Torah',
    definition: 'Maimonides\' (Rambam\'s) comprehensive 14-volume code of Jewish law, completed around 1180 CE.',
    extendedNotes:
  ...
  },
  {
    ...
    term: 'Shulchan Aruch',
    definition: 'The authoritative code of Jewish law compiled by Rabbi Yosef Karo in 1565, with glosses by Rabbi Moshe Isserles (Rema) for Ashkenazi practice.',
    extendedNotes:
  ...
  },
  {
    ...
    definition: 'Written rulings and decisions by rabbis in response to specific legal questions — a primary way halachah develops and adapts to new situations.',
    extendedNotes:
  ...
  // ─── Concepts ────────────────────────────────────────────────────
  {
    ...
    term: 'Canon',
    definition: 'The officially accepted collection of books considered authoritative scripture. The Jewish canon is the 24 books of the Tanach.',
    extendedNotes:
  ...
  },
  {
    ...
    term: 'Codify',
    definition: 'To organize laws or rules into a systematic, written code. Maimonides and Rabbi Yosef Karo codified Jewish law.',
    extendedNotes:
  ...
  },
  {
    ...
    term: 'Extrapolate',
    definition: 'To derive new conclusions or applications by extending known principles to new situations — a key method of Talmudic reasoning.',
    extendedNotes:
  ...
  // ─── Six Orders ──────────────────────────────────────────────────
  {
    ...
    term: 'Zeraim (Seeds)',
    definition: 'The first order of the Mishnah — deals with agricultural laws, blessings, and prayers. Contains 11 tractates.',
    extendedNotes:
  ...
  },
  {
    ...
    term: 'Moed (Festivals)',
    definition: 'The second order of the Mishnah — deals with Shabbat, holidays, and festival observances. Contains 12 tractates.',
    extendedNotes:
  ...
  },
  {
    ...
    term: 'Nashim (Women)',
    definition: 'The third order of the Mishnah — deals with marriage, divorce, and vows. Contains 7 tractates.',
    extendedNotes:
  ...
  },
  {
    ...
    definition: 'The fourth order of the Mishnah — deals with civil and criminal law, courts, and ethics. Contains 10 tractates.',
    extendedNotes:
  ...
  },
  {
    ...
    definition: 'The fifth order of the Mishnah — deals with Temple sacrifices, ritual slaughter, and sacred objects. Contains 11 tractates.',
    extendedNotes:
  ...
  },
  {
    ...
    definition: 'The sixth order of the Mishnah — deals with ritual purity and impurity. Contains 12 tractates.',
    extendedNotes:
  ...
  // ─── Primary Sources ─────────────────────────────────────────────
  {
    ...
    definition: '"Moses received the Torah from Sinai and transmitted it to Joshua; Joshua to the Elders; the Elders to the Prophets; and the Prophets transmitted it to the Men of the Great Assembly."',
    extendedNotes:
  ...
  },
  {
    ...
    definition: 'Maimonides\' teaching that at Sinai, Moses received both the Written Torah and the Oral Torah — the written commandments and their oral explanations.',
    extendedNotes:
  ...
  },
  {
    ...
    definition: 'A comparison of two major views on the Oral Torah: Rambam (Maimonides) sees it as a complete divine transmission from Sinai; Saadiah Gaon emphasizes the role of human reasoning and interpretation alongside received tradition.',
    extendedNotes:
  ...
  // ─── Oral Law Examples ───────────────────────────────────────────
  {
    ...
    definition: 'The Torah commands binding "a sign upon your hand" but never explains what tefillin are, what they contain, or how to make them — all details come from the Oral Torah.',
    extendedNotes:
  ...
  },
  {
    ...
    definition: 'The Torah states three times "Do not cook a kid in its mother\'s milk." The Oral Torah extrapolates this into the comprehensive prohibition against mixing, cooking, or eating any meat with any dairy.',
    extendedNotes:
  ...
  // === ADDITIONAL KEY FIGURES & CONCEPTS ===
  {
    ...
    definition: "The compiler of the Mishnah (c. 200 CE). Known simply as 'Rabbi' or 'Rebbi.' A wealthy and politically powerful Nasi (patriarch) of the Jewish community in the Land of Israel.",
  ...
  },
  {
    ...
    definition: "A body of 120 scribes, sages, and prophets who led the Jewish people at the beginning of the Second Temple period (c. 5th–3rd century BCE). They established many core liturgical practices.",
  ...
  },
  {
    ...
    definition: "Five pairs of sages who led the Sanhedrin from approximately 200 BCE to 10 CE. Each pair consisted of a Nasi (president) and an Av Beit Din (head of court).",
  ...
  },
  {
    ...
    term: "Sanhedrin",
    definition: "The supreme court of 71 rabbis in ancient Israel that served as the highest judicial and religious authority. Based in Jerusalem near the Temple.",
  ...
  },
  {
    ...
    term: "Perek (Chapter)",
    definition: "A chapter within a tractate (Masechet) of the Mishnah or Talmud. Each tractate is divided into chapters, and each chapter into individual Mishnayot (teachings).",
  ...
  },
  {
    ...
    term: "Midrash",
    definition: "A genre of rabbinic literature that interprets Biblical texts through homiletical stories, parables, and legal analysis. Derives new meanings by closely reading the Torah's words.",
  ...
  },
  {
    ...
    term: "Tosefta",
    definition: "A compilation of Tannaitic teachings that parallels and supplements the Mishnah. Organized in the same order as the Mishnah but contains additional material not included by Rabbi Yehudah HaNasi.",
  ...
  },
  {
    ...
    definition: "The Written Torah is deliberately incomplete — it assumes the Oral Law. Without the Oral Law, many commandments cannot be understood or practiced (e.g., tefillin, shechita, Shabbat details).",
